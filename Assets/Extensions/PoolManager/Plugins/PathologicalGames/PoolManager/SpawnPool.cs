...
namespace PathologicalGames
{
    ...
    public sealed class SpawnPool : MonoBehaviour, IList<Transform>
    {
        ...
        public readonly bool useManager = false;
        /// <summary>
        ...
        {
            Transform prefab = _prefabPools[0].prefab;
            if (prefab == null)
            {
                //throw new System.ArgumentNullException("Missing prefab when spawn<T>()");
                Debug.LogError($"Missing pf - {typeof(T)}");
                return null;
            }
